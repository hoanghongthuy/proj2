    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_left">
        	<div class="templatemo_content_left_section">
                ...
                <ul>
                    @foreach($loai as $r)
                    <li><a href="{{url('')}}/loai/{{$r->maloai}}">{{ $r->tenloai }}</a></li>
                    @endforeach
            	</ul>
            </div>
			<div class="templatemo_content_left_section">
        ...
        <div id="templatemo_content_right">
        	...
        	<div class="templatemo_product_box">
                <h1>Photography  <span>(by Best Author)</span></h1>
                   <img src="{{url('/book')}}/{{$value->hinh}}" style="width:100px" alt="image" />
                <div class="product_info">
                	<p>Etiam luctus. Quisque facilisis suscipit elit. Curabitur...</p>
                  <h3>{{ number_format($value->gia) }}</h3>
                    <div class="buy_now_button"><a href="subpage.html">Buy Now</a></div>
                    <div class="detail_button"><a href="{{url('')}}/chitiet/{{$value->masach}}">Detail</a></div>
                </div>
            ...
            <a href="subpage.html"><img src="{{url('')}}/images/templatemo_ads.jpg" alt="ads" /></a>
